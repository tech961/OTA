...
namespace Rs.Persistence.Migrations
{
    ...
    [Migration("20250912104344_Fixed_BrithDate")]
    partial class Fixed_BrithDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Carts", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CartItems", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.DiscountCoupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DiscountCoupons", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.InventoryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InventoryTransactions", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Orders", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrderItems", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Payments", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Products", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.ProductAttribute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductAttributes", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductCategories", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductImages", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.ProductSuitability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductId", "Species", "Breed", "AgeGroup", "Size", "HealthCondition")
                        .IsUnique()
                        .HasFilter("[Breed] IS NOT NULL");

                    b.ToTable("ProductSuitabilities", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Reviews", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Shipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Shipments", "PetShop");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Wishlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.CartItem", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.PetShop.Cart", "Cart")
                        .WithMany("Items")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rs.Domain.Aggregates.PetShop.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Order", b =>
                {
                    b.OwnsOne("Rs.Domain.Aggregates.PetShop.ValueObjects.Address", "BillingAddress", b1 =>
                        {
                            ...
                            b1.ToTable("Orders", "PetShop");

                            b1.WithOwner()
                                .HasForeignKey("OrderId");
                        });

                    b.OwnsOne("Rs.Domain.Aggregates.PetShop.ValueObjects.Address", "ShippingAddress", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.OrderItem", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.PetShop.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Payment", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.PetShop.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("Rs.Domain.Aggregates.PetShop.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Product", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.PetShop.ProductCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.ProductCategory", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.PetShop.ProductCategory", "ParentCategory")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.PetShop.Shipment", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.PetShop.Order", "Order")
                        .WithOne("Shipment")
                        .HasForeignKey("Rs.Domain.Aggregates.PetShop.Shipment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
